...
function XPclass()
{
	/*all characters will start off at lvl 1.
		will hopefully feature the following: 
	 	gaining XP depending on either the type of enemy defeated and that enemy lvl or both.
	...
	*/
	...
	this.startingXP = 0.0;
	this.currentXP = this.calculateCurrentXP(this.lvl, this.multiplier);
	...
	this.setXPdrop = function(characterType)
	{
	...
	this.setComboMultiplier = function()
	{
